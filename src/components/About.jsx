    ...
    <>
      <div className='relative overflow-hidden lg:overflow-visible'>
        ...
        >
          ...
          specializing in the MERN stack with expertise in React, Node.js,
          MongoDB, and TypeScript. I build production-ready applications
          integrating AI, real-time systems, and payment gateways. I write
          clean, scalable code and thrive across the entire stack — from MongoDB
          schemas to React interfaces. Let's work together to bring your ideas
          to life!
        </motion.p>
